...
export const getInventoryService = async (item_name, item_type, available_quantity) => {
    try {
        const inventoryDetails = await inventory_model.find(item_name, item_type, available_quantity);
